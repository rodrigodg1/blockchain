...
#before this script, run export commands for APPROVE and CONTRACT in the terminal
...
echo "Prescription content transaction" >> results_transactions.txt
echo "" >> results_transactions.txt
echo $APPROVE >> results_transactions.txt
echo "" >> results_transactions.txt
echo "" >> results_transactions.txt
